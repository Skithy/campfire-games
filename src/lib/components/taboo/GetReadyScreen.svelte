...
<div class="flex flex-1 flex-col items-center justify-between gap-6">
  <div class="flex flex-1 flex-col items-center justify-center gap-6">
    ...
    <div class={["max-w-md", "p-6", "text-center", "bg-white/5", "rounded-xl", "backdrop-blur-sm", "space-y-3"]}>
      <h3 class="text-lg font-bold text-white">Rules for the Clue Giver:</h3>
      <ul class="space-y-2 text-left text-sm text-white/80">
        <li class="flex gap-2">
          <i class="mt-0.5 shrink-0 text-xs fa-solid fa-check" style:color={teamColor.toRgb()}></i>
          <span>Give clues to help your team guess the word</span>
        </li>
        <li class="flex gap-2">
          <i class="mt-0.5 shrink-0 text-xs text-red-400 fa-solid fa-xmark"></i>
          <span>Don't say forbidden words or parts of the main word</span>
        </li>
        <li class="flex gap-2">
          <i class="mt-0.5 shrink-0 text-xs text-white/60 fa-solid fa-forward"></i>
          <span>Skip gives the other team a point</span>
        </li>
        <li class="flex gap-2">
          <i class="mt-0.5 shrink-0 text-xs text-white/60 fa-solid fa-stopwatch"></i>
